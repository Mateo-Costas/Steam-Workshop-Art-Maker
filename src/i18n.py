...
ES = {
    ...
    "tip_pipeline": "Todo automatico: IA + colores + fragmentar + optimizar (PRO)",
    ...
    "tip_validate_profile": "Comprobar tu perfil Steam y nivel para showcases (PRO)",
    "tip_export_zip": "Empaquetar fragmentos + instrucciones en un ZIP (PRO)",
    ...
    "tip_upload_tool": "Subida automatica (PRO)",
...
EN = {
    ...
    "tip_pipeline": "Fully automatic: AI + colors + fragment + optimize (PRO)",
    ...
    "export_zip": "Export ZIP",
    "tip_validate_profile": "Check your Steam profile and showcase level (PRO)",
    "tip_export_zip": "Pack fragments + instructions into a ZIP (PRO)",
    ...
    "tip_upload_tool": "Automatic upload (PRO)",
...
PT = {
    ...
    "tip_pipeline": "Tudo automático: IA + cores + fragmentar + otimizar (PRO)",
    ...
    "tip_validate_profile": "Verificar seu perfil Steam e nível para showcases (PRO)",
    "tip_export_zip": "Empacotar fragmentos + instruções em um ZIP (PRO)",
    ...
    "tip_upload_tool": "Envio automático (PRO)",
